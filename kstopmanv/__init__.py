...
CRUISE_V_MIN = 35   # Velocidad mínima de cruise (m)

IN_AREA_D = 100     # Radio de estado IN_AREA (m)
...
IN_AREA_V = 30      # Velocidad de estado IN_AREA (k/h)
...
STOP_POINTS = [200,600,1000]    # Distancia a los puntos 
                                # de parada
...
TELEM_ACTIVE = True         # Esta la telemetría activa ??
